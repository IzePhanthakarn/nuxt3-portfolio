...
const temperature = 1567;
const totalWallet = 1259;
const planTitle = ref('today')
const gatgets: Gatget[] = [
    { title: 'Daily Weight', icon: 'uil:weight', value: `${testimonial} Kilogram`, link: '/user' },
    { title: 'Normal (healthy)', icon: 'streamline:interface-time-stop-watch-quarter-time-fifteen-quarter-stopwatch-minute-measure-seconds', value: `BMI ${totalPlan}`, link: '/plan' },
    { title: 'Daily Burning Rate', icon: 'uil:fire', value: `BMR ${totalWallet}`, link: '/wallet' },
    { title: 'Daily Food', icon: 'ion:fast-food-outline', value: `${statusHealth} Calories`, link: '/health' },
    { title: 'Daily Exercise', icon: 'healthicons:exercise-walking', value: `${temperature} Calories`, link: '/' }
]
    ...
    <div class="w-full h-full flex flex-col">
        <div class="w-full flex items-center justify-between bg-neutral rounded-xl text-base-100 px-3 py-1.5 shadow">
            <div class="flex items-center space-x-2">
                <Icon name="icon-park-outline:muscle" size="40" />
                <h1 class="text-3xl font-medium py-1">Health</h1>
            </div>
        </div>
        ...
        <div class="w-full mt-6 h-full rounded-xl column-1">
            <div class="w-full height-content grid grid-cols-2 gap-6">
                    ...
                    <div
                        ...
                        <div class="w-full flex justify-between items-center mb-4">
                            <div class="flex items-center space-x-2 text-2xl font-medium text-base-100">
                                <Icon name="ion:fast-food-outline" size="32" />
                                <p>Food History</p>
                            </div>
                                ...
                                <table class="table border-collapse table-auto w-full">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sticky top-0 text-center bg-neutral-content text-base py-2">Calories</th>
                ...
                <div class="w-full height-table overflow-y-scroll rounded-xl">
                    <div
                        ...
                        <div class="w-full flex justify-between items-center mb-4">
                            <div class="flex items-center space-x-2 text-2xl font-medium text-base-100">
                                <Icon name="healthicons:exercise-walking" size="32" />
                                ...
                                <table class="table border-collapse table-auto w-full">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sticky top-0 text-center bg-neutral-content text-base py-2">Time</th>
                                            <th class="sticky top-0 text-center bg-neutral-content text-base py-2">List</th>
                                            <th class="sticky top-0 text-center bg-neutral-content text-base py-2">Duration
                                                (min)</th>
                                            <th class="sticky top-0 text-center bg-neutral-content text-base py-2">Calories</th>
                                            <th class="sticky top-0 text-center bg-neutral-content text-base py-2">Edit</th>
                                        </tr>
