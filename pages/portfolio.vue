...
const softskillTags: portfolioCard[] = [
    {
        img: "/img/projects/nuxt3-portfolio.png", projectTag: "UI Website", name: "My Portfolio Website", icon: "ph:globe", lastUpdate: "Mar 23, 2023", link: "/about", description: "This project is a portfolio website that showcases my skills and displays various projects that I have worked on, demonstrating my experience in project development. I utilized nuxt3 and JavaScript libraries to create this project. I am committed to consistently updating the content, whether it be new projects or newly acquired skills that I have learned.", tags: [
    ...
    {
        img: "/img/projects/nuxt2-portfolio.png", projectTag: "UI Website", name: "My Portfolio Website (Old version)", icon: "ph:globe", lastUpdate: "Oct 24, 2022", link: "/about", description: "This project is a portfolio website that showcases my skills and displays various projects that I have worked on, demonstrating my experience in project development. I utilized nuxt3 and JavaScript libraries to create this project.", tags: [
    ...
    {
        img: "/img/projects/html-portfolio.png", projectTag: "UI Website", name: "My Portfolio Website (Old version)", icon: "ph:globe", lastUpdate: "Dec 31, 2021", link: "/about", description: "This project is a portfolio website that showcases my skills and displays various projects that I have worked on, demonstrating my experience in project development. I utilized nuxt3 and JavaScript libraries to create this project.", tags: [
...
const tagList = ['All','UI Website', 'Web Service', 'Programming', 'Spreadsheet']
...
<template>
    <div class="w-full text-white flex justify-center items-center pt-24">
        <div class="container px-5 flex flex-col justify-center items-center">
            ...
            <!-- Search box -->
            <div class="w-full sm:w-11/12 mt-4 sm:mt-8 text-black font-semibold">
                <form class="form w-full px-3.5 h-10 relative flex items-center bg-white before:bg-primary"
                    ...
                    <input class="input w-full h-full p-4 bg-transparent border-none" placeholder="Project's name"
                        type="text">
            ...
            <div class="w-full 2xl:w-11/12 mt-4">
                <ul class="flex h-10 items-center space-x-2">
                    <li class="h-full flex items-center px-6 rounded-full bg-color-base border-2 cursor-pointer duration-300 hover:scale-105 active:scale-95" :class="{'border-primary':tagSelected===tag}" v-for="(tag,index) in tagList" :key="index" @click="select(tag)">{{ tag }}</li>
                </ul>
            </div>

            <div class="w-full 2xl:w-11/12 mt-4 grid grid-cols-4 gap-5 border-t-2 py-4">
                <div v-for="(slide, index) in softskillTags" :key="index" class="duration-300 scale-1 opacity-1" :class="{'hidden opacity-0 scale-90':slide.projectTag!=tagSelected && tagSelected != 'All'}">
            ...
            <div class="h-screen w-full bg-color-base"></div>
        </div>
    </div>
</template>
