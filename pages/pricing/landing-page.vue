...
const checkLists = ["Free Design", "Free Domain Name", "Free support for the first 3 months", "Free server fee for the first 3 months", "Completed in 7-14 days"]
...
<template>
   <div class="container text-white mx-auto pt-20 pb-10 height-scree">
      ...
      <div data-aos="fade-right" class="w-full flex items-center justify-between">
         <div class="flex items-center space-x-1">
            ...
            <h1 class="text-3xl font-medium">Landing Page Website</h1>
         </div>
         <NuxtLink to="/pricing"
            class="flex items-center space-x-1 border-2 w-fit py-1 pl-0.5 pr-2 rounded-lg duration-100 hover:border-primary">
      ...
      <div class="w-full h-full mt-4 grid grid-cols-2 gap-8">
         <div class="w-full h-full bg-color-base2 rounded-3xl p-3">
            <div class="w-full flex items-center space-x-2">
               ...
               <div>
                  <p class="text-lg">Landing Page Website</p>
                  <h1 class="text-3xl font-medium">39.99 $ <span class="text-gray-500 text-2xl">(
                        1,499 ฿ )</span></h1>
               </div>
            </div>
            <hr class="my-2">
         ...
         <div class="w-full bg-color-base2 rounded-2xl p-5 pb-0 col-span-2 grid grid-cols-3 gap-x-8">
            ...
            <div class="login__box grid pb-[2px] items-center gap-x-2 border-b-2 border-white">
               ...
               <div class="relative">
                  <input type="text" class="login__input w-full py-3 pb-2 outline-none bg-transparent relative z-[1]"
            ...
            <div class="login__box grid pb-[2px] items-center gap-x-2 border-b-2 border-white">
               ...
               <div class="relative">
                  <input type="email" class="login__input w-full py-3 pb-2 outline-none bg-transparent relative z-[1]"
                     placeholder=" " spellcheck="false">
            ...
            <div class="login__box grid pb-[2px] items-center gap-x-2 border-b-2 border-white">
               ...
               <div class="relative">
                  <input type="tell" class="login__input w-full py-3 pb-2 outline-none bg-transparent relative z-[1]"
                     placeholder=" " spellcheck="false">
            ...
            <div class="col-span-3 flex flex-col mt-8 pb-0.5">
               ...
               <textarea name="description" rows="5" class="rounded-2xl bg-gray-700 p-2" spellcheck=false></textarea>
            </div>
            ...
            <div class="w-full flex items-center justify-end">
               <BaseButton class="h-fit w-fit">Submit</BaseButton>
            </div>
         </div>
      </div>
   </div>
